...
$('.reveal__button__text').css('background',$(this).val());
});
$('#colorSelect-f').change(function() {
$('.reveal__button__text').css('color',$(this).val());
});
$('#colorSelect-hf').change(function() {
$('.reveal__button__hidden__content').css('color',$(this).val());
});
$('#colorSelect-hbg').change(function() {
$('.reveal__button__hidden__content').css('background-color',$(this).val());
});
$('#colorSelect-bor').change(function() {
$('.reveal__button__hidden__content').css('border-color',$(this).val());
});
